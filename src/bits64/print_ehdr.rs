use crate::elf::*;
use crate::helpers::get_elf_type64;
...
pub fn print_ehdr(ehdr: &Elf64Ehdr) {
    ...
    println!(
        "  {:<35} {}",
        "Class:",
        match ehdr.e_ident[EI_CLASS as usize] {
            ELFCLASS32 => "ELF32",
            ELFCLASS64 => "ELF64",
            _ => "unknown",
        }
    ...
    println!(
        "  {:<35} {}",
        "Data:",
        match ehdr.e_ident[EI_DATA as usize] {
    ...
    println!(
        "  {:<35} {} (current)",
        "Version:", ehdr.e_ident[EI_VERSION as usize]
    );
    println!("  {:<35} {}", "OS/ABI:", osabi_text(ehdr));
    println!(
        "  {:<35} {}",
        "ABI Version:", ehdr.e_ident[EI_ABIVERSION as usize]
    );
    println!("  {:<35} {}", "Type:", get_elf_type64(ehdr));
